  ...
  \cveducationentry
    ...
    {Jan 2022 - Nov 2024} % Date(s)
    {
      \begin{cvitems}
        ...
        % \item {Worked with our Staff MLE to design and deploy an end-to-end ML pipeline for forecasting aggregate-level series. The pipeline involves the orchestration of both shared and model-specific pre-processing, tuning, and inference. Ensemble consists of over 30 model variants (e.g. XGBoost, LightGBM, CatBoost) that consistently represented in the top 3 performing models presented to leadership during our weekly demand reviews.}
